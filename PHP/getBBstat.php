...
if($_SERVER['REQUEST_METHOD']=='POST'){
	...
	$sql = "SELECT BBathlete.fname, BBathlete.lname, BBstat.stat_type, BBstat.stat_number FROM BBathlete INNER JOIN BBstat ON BBathlete.BBathleteID=BBstat.BBathleteID";
