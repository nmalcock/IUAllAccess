...
protocol PullTeamStatsDataProtocol: class {
    func itemsDownloaded(items: NSArray)
}


class PullTeamStatsData: NSObject, URLSessionDataDelegate {
    
    
    
    weak var delegate: PullTeamStatsDataProtocol!
    
    let urlPath =  "https://cgi.sice.indiana.edu/~team58/get_team_stat.php"
