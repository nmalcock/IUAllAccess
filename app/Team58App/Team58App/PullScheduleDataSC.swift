...
protocol PullScheduleDataSCProtocol: class {
    func itemsDownloaded(items: NSArray)
}

class PullScheduleDataSC: NSObject, URLSessionDataDelegate {
    
    
    
    weak var delegate: PullScheduleDataSCProtocol!
    
    let urlPath =  "https://cgi.sice.indiana.edu/~team58/getSCsched.php"
    func downloadItems() {
    ...
    func parseJSON(_ data:Data) {
        ...
        for i in 0 ..< jsonResult.count
        {
            ...
            let schedule = StoreScheduleDataSC()
