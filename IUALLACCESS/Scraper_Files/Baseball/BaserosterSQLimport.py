...
for row in baseroster:
    cursor.execute('INSERT INTO BSathlete(fname,lname,number,position,year,height,weight,hometown,highschool,image_path,teamID) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)',row)
db.commit()
