...
protocol PullScheduleDataFBProtocol: class {
    func itemsDownloaded(items: NSArray)
}

class PullScheduleDataFB: NSObject, URLSessionDataDelegate {
    
    
    
    weak var delegate: PullScheduleDataFBProtocol!
    
    let urlPath =  "https://cgi.sice.indiana.edu/~team58/getFBsched.php"
    func downloadItems() {
    ...
    func parseJSON(_ data:Data) {
        ...
        for i in 0 ..< jsonResult.count
        {
            ...
            let schedule = StoreScheduleDataFB()
